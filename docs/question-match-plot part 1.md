...
I interpret this as: find a point on the functions where one of the three derivatives gives a positive number, another gives a negative and the third gives 0/neutral. For example, you could have a point that gives Fxy=1, Fx = 0, Fy=-1, that would be a solution.
