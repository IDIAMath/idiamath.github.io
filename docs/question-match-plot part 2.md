...
The function may have any amount of local min/max, in return the student will be given the corresponding amount of min/max points on the 2D plane which they have to match approximately to the local min/max of the given function.
